...
import view.financial.items.BaseItemsPanel
...
class AccountsPanel(width: Int,  height: Int, component: Component, uiComponents: ApplicationUIComponents, applicationState: ApplicationState) :
        BaseItemsPanel(width, height, component, uiComponents, applicationState), BudgetViewHandler {
    ...
    override fun build(){
        ...
        this.savingsAccountsPanel =
                SavingsAccountPanel(width!!-4, multiAccountSubPanelHeight!!+3,
