...
class CheckingAccountPanel(width: Int, height: Int, component: Component,
                           uiComponents: ApplicationUIComponents, applicationState: ApplicationState):
        BaseAccountsPanel(width, height, component, false, CHECKING_ACCOUNT_TITLE,
        uiComponents, applicationState, AccountType.Savings) {
