...
class ItemConfigurationPanel(var name: String, var due: LocalDate, var isRequired: Boolean, var isAutopay: Boolean,
                             ...
                             width: Int, height: Int, var targetSavingsAccountName: String,
        ...
        BaseConfigurationPanel(width, height, useHorizontalLayout, position, wrapWithBox), ItemConfigurationHandler{
